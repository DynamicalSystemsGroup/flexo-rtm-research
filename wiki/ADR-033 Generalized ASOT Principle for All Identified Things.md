...
- **Federated verification scales.** Each qualified dereferencer accesses what they can; the audit composes locally without any party needing universal access (per [[Federated Audit and Composition]] and [[ADR-025 Reproducibility is Structural and Local]]).
