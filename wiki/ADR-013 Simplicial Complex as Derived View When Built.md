...
- The complex vocabulary (`rtm:AssuranceComplex`, `rtm:AssuranceFace`, `rtm:AssuranceTriple` — see [[ADR-020 Vocabulary Alignment with Zargham 2026]]) ships in v0.1 ontology forward-compatibly
