...
6. **The topological framework is future work, not v0.1.** Zargham (2026)'s typed simplicial complex framework requires a community-curated registry of pre-approved artifact types to terminate the recursive completeness check. Premature scope for v0.1. Documented in [[Topological Framework Future Work]]; vocabulary ships forward-compatibly.
