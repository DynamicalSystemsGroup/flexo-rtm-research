...
6. **Methodology agnosticism is a foundational axiom.** `flexo-rtm` does not commit to any specific assurance methodology. INCOSE / ISO 15288, DO-178C, NASA Phase A–F, ISO 9001, Agile, MIL-STD-498, and custom phasing participate on equal footing. Locked in [[ADR-032 Methodology Agnosticism as Foundational Axiom]].
